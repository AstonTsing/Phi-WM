...
export TMPDIR=${TMPDIR:-/root/tianyi/.cache/tmp/starvla_qwenmip_dino}
export TRITON_CACHE_DIR=${TRITON_CACHE_DIR:-/root/tianyi/.cache/triton/starvla_qwenmip_dino}
export TORCH_EXTENSIONS_DIR=${TORCH_EXTENSIONS_DIR:-/root/tianyi/.cache/torch_extensions/starvla_qwenmip_dino}
...
Framework_name=${Framework_name:-QwenMIPDINO}
...
config_yaml=${config_yaml:-examples/Robocasa_tabletop/train_files/starvla_qwenmip_dino_robocasa_gr1.yaml}
...
run_id=${run_id:-robocasa_qwenmip_dino_200k}
...
echo "=== StarVLA QwenMIPDINO RoboCasa-GR1 ==="

...
class FourierGr1ArmsWaistLeWMDataConfig(FourierGr1ArmsWaistDataConfig):
    future_video_keys = ["future_video.ego_view"]
...
class FourierGr1ArmsWaistVideoFDMDataConfig(FourierGr1ArmsWaistLeWMDataConfig):
    observation_indices = [-3, -2, -1, 0]


class FourierGr1ArmsWaistRolloutFDMDataConfig(FourierGr1ArmsWaistLeWMDataConfig):
    observation_indices = [0]
    future_observation_indices = [4, 8, 12, 16]


ROBOT_TYPE_CONFIG_MAP = {
    "fourier_gr1_arms_waist": FourierGr1ArmsWaistDataConfig(),
    "fourier_gr1_arms_waist_lewm": FourierGr1ArmsWaistLeWMDataConfig(),
    "fourier_gr1_arms_waist_video_fdm": FourierGr1ArmsWaistVideoFDMDataConfig(),
    "fourier_gr1_arms_waist_rollout_fdm": FourierGr1ArmsWaistRolloutFDMDataConfig(),
}
...
DATASET_NAMED_MIXTURES["fourier_gr1_unified_1000_lewm"] = [
    (dataset_name, weight, "fourier_gr1_arms_waist_lewm")
    for dataset_name, weight, _robot_type in DATASET_NAMED_MIXTURES["fourier_gr1_unified_1000"]
]

DATASET_NAMED_MIXTURES["fourier_gr1_unified_1000_video_fdm"] = [
    (dataset_name, weight, "fourier_gr1_arms_waist_video_fdm")
    for dataset_name, weight, _robot_type in DATASET_NAMED_MIXTURES["fourier_gr1_unified_1000"]
]


DATASET_NAMED_MIXTURES["fourier_gr1_unified_1000_rollout_fdm"] = [
    (dataset_name, weight, "fourier_gr1_arms_waist_rollout_fdm")
    for dataset_name, weight, _robot_type in DATASET_NAMED_MIXTURES["fourier_gr1_unified_1000"]
]

...
export TMPDIR=${TMPDIR:-/root/tianyi/.cache/tmp/starvla_acteffect_state}
export TRITON_CACHE_DIR=${TRITON_CACHE_DIR:-/root/tianyi/.cache/triton/starvla_acteffect_state}
export TORCH_EXTENSIONS_DIR=${TORCH_EXTENSIONS_DIR:-/root/tianyi/.cache/torch_extensions/starvla_acteffect_state}
...
config_yaml=${config_yaml:-examples/LIBERO/train_files/starvla_acteffect_state_libero.yaml}
...
run_id=${run_id:-libero_acteffect_state_v2}
...
echo "=== StarVLA ActEffect LIBERO State ==="

...
export TMPDIR=${TMPDIR:-/root/tianyi/.cache/tmp/starvla_qwenoft_mip_dino_fdm}
export TRITON_CACHE_DIR=${TRITON_CACHE_DIR:-/root/tianyi/.cache/triton/starvla_qwenoft_mip_dino_fdm}
export TORCH_EXTENSIONS_DIR=${TORCH_EXTENSIONS_DIR:-/root/tianyi/.cache/torch_extensions/starvla_qwenoft_mip_dino_fdm}
...
config_yaml=${config_yaml:-examples/Robocasa_tabletop/train_files/starvla_qwenoft_mip_dino_fdm_robocasa_gr1.yaml}
...
run_id=${run_id:-robocasa_qwenoft_mip_dino_fdm_state58_200k}
...
echo "=== StarVLA QwenOFTMIPDINOFDM RoboCasa-GR1 ==="

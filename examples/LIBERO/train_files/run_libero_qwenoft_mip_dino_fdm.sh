...
config_yaml=${config_yaml:-examples/LIBERO/train_files/starvla_qwenoft_mip_dino_fdm_libero.yaml}
...
run_id=${run_id:-libero_qwenoft_mip_dino_fdm_nostate_100k}
...
echo "=== StarVLA QwenOFTMIPDINOFDM LIBERO ==="

...
export config_yaml=${config_yaml:-examples/LIBERO/train_files/starvla_qwenoft_mip_dino_fdm_action_query_rank_vlm_latent_cot_libero.yaml}
export state_dim=${state_dim:-7}
export run_id=${run_id:-libero_qwenoft_mip_dino_fdm_action_query_rank_vlm_latent_cot16_state7_100k}
...
LATENT_COT_FUTURE_IMAGE_INDICES=${LATENT_COT_FUTURE_IMAGE_INDICES:-0,1}
LATENT_COT_ACTION_GRADIENT=${LATENT_COT_ACTION_GRADIENT:-true}

exec bash "${SCRIPT_DIR}/run_libero_qwenoft_mip_dino_fdm_action_query_rank.sh" \

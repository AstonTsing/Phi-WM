...
config_yaml=${config_yaml:-examples/LIBERO/train_files/starvla_qwengr00t_libero.yaml}
...
run_id=${run_id:-libero_qwengr00t_official_100k}
...
echo "REPEATED_DIFFUSION_STEPS: ${repeated_diffusion_steps}"

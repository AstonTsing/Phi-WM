...
export config_yaml=${config_yaml:-examples/LIBERO/train_files/starvla_qwenoft_mip_dino_fdm_action_query_rank_latent_cot_libero.yaml}
export state_dim=${state_dim:-7}
export run_id=${run_id:-libero_qwenoft_mip_dino_fdm_action_query_rank_latent_cot_state7_100k}

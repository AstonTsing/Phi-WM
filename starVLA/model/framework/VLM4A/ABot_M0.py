...
class ABot_M0(baseframework):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        vggt_default_path = "/root/tianyi/starVLA/playground/Pretrained_models/facebook/VGGT-1B"
        vggt_model_id = os.getenv(
            "VGGT_MODEL",
            vggt_default_path if os.path.isdir(vggt_default_path) else "facebook/VGGT-1B",
        )
        self.spatial_model = spatial_model = VGGT.from_pretrained(vggt_model_id)

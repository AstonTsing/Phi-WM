...
def read_mode_config(pretrained_checkpoint):
    ...
    if os.path.isfile(pretrained_checkpoint):
        ...
        # Get paths for config, dataset statistics, and pretrained checkpoint.
        # Prefer the full config because the accessed-only config.yaml may omit
        # eval-side adapter fields such as pack_multiview/policy_image_history.

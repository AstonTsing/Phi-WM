    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: ``config_overrides`` may contain a nested mapping merged
                over the saved config before model construction. Other legacy
                keywords remain ignored for backward compatibility.

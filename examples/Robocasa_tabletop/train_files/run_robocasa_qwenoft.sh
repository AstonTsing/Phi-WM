...
config_yaml=${config_yaml:-examples/Robocasa_tabletop/train_files/starvla_qwenoft_robocasa_gr1.yaml}
...
run_id=${run_id:-robocasa_qwenoft_gr1_200k}
...
echo "=== StarVLA QwenOFT RoboCasa-GR1 ==="

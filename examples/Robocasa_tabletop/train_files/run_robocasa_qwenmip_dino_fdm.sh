...
export TMPDIR=${TMPDIR:-/root/tianyi/.cache/tmp/starvla_qwenmip_dino_fdm}
export TRITON_CACHE_DIR=${TRITON_CACHE_DIR:-/root/tianyi/.cache/triton/starvla_qwenmip_dino_fdm}
export TORCH_EXTENSIONS_DIR=${TORCH_EXTENSIONS_DIR:-/root/tianyi/.cache/torch_extensions/starvla_qwenmip_dino_fdm}
...
Framework_name=${Framework_name:-QwenMIPDINOFDM}
...
config_yaml=${config_yaml:-examples/Robocasa_tabletop/train_files/starvla_qwenmip_dino_fdm_robocasa_gr1.yaml}
...
run_id=${run_id:-robocasa_qwenmip_dino_fdm_200k}
...
echo "=== StarVLA QwenMIPDINOFDM RoboCasa-GR1 ==="

...
config_yaml=${config_yaml:-examples/LIBERO/train_files/starvla_qwenmip_dino_fdm_libero.yaml}
...
run_id=${run_id:-libero_qwenmip_dino_fdm_state7_100k}
...
echo "=== StarVLA QwenMIPDINOFDM LIBERO ==="

...
export TMPDIR=${TMPDIR:-/root/htq/.cache/tmp/starvla_acteffect_lewm}
export TRITON_CACHE_DIR=${TRITON_CACHE_DIR:-/root/htq/.cache/triton/starvla_acteffect_lewm}
export TORCH_EXTENSIONS_DIR=${TORCH_EXTENSIONS_DIR:-/root/htq/.cache/torch_extensions/starvla_acteffect_lewm}

...
export config_yaml=${config_yaml:-examples/Robocasa_tabletop/train_files/starvla_qwenoft_mip_dino_fdm_direct_rank_robocasa_gr1.yaml}
export state_dim=${state_dim:-58}
export run_id=${run_id:-robocasa_qwenoft_mip_dino_fdm_direct_rank_state58_200k}

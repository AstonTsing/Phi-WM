...
config_yaml=${config_yaml:-examples/Robocasa_tabletop/train_files/starvla_acteffect_lewm_robocasa_gr1.yaml}
...
run_id=${run_id:-robocasa_acteffect_lewm_state58_200k}
...
echo "=== StarVLA ActEffectLewm RoboCasa-GR1 ==="
